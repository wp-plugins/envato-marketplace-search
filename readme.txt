...
= 1.0.1 =
* Fixed typo in curl function name
...
= 1.0.1 =
The curl fallback will not work with the previous version due to a typo, upgrade if you are experiencing an issue getting results.
